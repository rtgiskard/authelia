...
func (m *MockUserProvider) CreateUser(details authentication.UserDetailsCreate) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserProviderMockRecorder) CreateUser(details any) *gomock.Call {
